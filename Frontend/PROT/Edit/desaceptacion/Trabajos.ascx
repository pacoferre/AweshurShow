<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Trabajos.ascx.cs" Inherits="LCC.WebGestion.presupuestos.desaceptacion.Trabajos" %>
<ele:CajaEdicion ID="C3" runat="server" Titulo="Trabajos Existentes">
    <prot:GridEnEditor id="ge1" runat="server" Width="100%" CssClass="especial" DataMember="TrabajosPresupuesto"
