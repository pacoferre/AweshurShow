<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FacturasTarifas.ascx.cs" Inherits="LCC.WebGestion.presupuestos.tarifas.FacturasTarifas" %>
<ele:CajaEdicion ID="C3" runat="server" Titulo="Facturas Existentes">
    <prot:GridEnEditor id="ge2" runat="server" Width="100%" CssClass="especial" DataMember="FacturasTarifasPresupuesto"
